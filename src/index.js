...
const accountModal=document.querySelector('[data-modal="account"]');document.addEventListener('click',e=>{if(e.target.closest('[data-open-account-modal]'))accountModal.hidden=false;if(e.target===accountModal||e.target.closest('[data-close-modal]'))accountModal.hidden=true});document.addEventListener('keydown',e=>{if(e.key==='Escape'&&accountModal)accountModal.hidden=true});
